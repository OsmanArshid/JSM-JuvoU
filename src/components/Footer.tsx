...
const Footer = () => {
  return (
    <Section>
      <div className="justify-center items-center text-lg flex -mt-6 font-now text-n-2 font-semibold">
        {" "}
        Not your typical
        <img src={footpic} width={30} />
        er
      </div>
      <footer className="w-full pt-[80px] xl:-mb-[70px] lg:-mb-[50px] md:-mb-[24px] sm:-mb-[24px] ">
        {/* background grid */}
