...
//   return (
//     <div>
//       <div className="p-3 flex gap-[1rem] max-lg:flex-wrap">
//         {pricing.map((item) => (
//           <div
//             key={item.id}
//             className="max-lg:w-full h-full px-6 bg-n-8 border border-n-4 rounded-[2rem] lg:w-auto even:py-14 odd:py-6 odd:my-8 [&>h4]:first:text-n-2 [&>h4]:even:text-color-2 [&>h4]:last:text-n-2"
//           >
