...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "juvou.digital@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          <div className="font-now font-extralight md:max-w-32 md:text-xs lg:text-base text-sm text-[#C1C2D3] z-10">
            {description}
          </div>
          {/* add text-3xl max-w-96 , remove text-neutral-600 dark:text-neutral-300*/}
          {/* remove mb-2 mt-2 */}
          <div
            className={`font-now text-lg lg:text-3xl max-w-96 font-semibold z-10`}
          >
            {title}
          </div>
              ...
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                {leftLists.map((item, i) => (
                  <span
                    ...
                    lg:opacity-100 rounded-lg text-center bg-[#3a3b49]"
                  >
                    {item}
                  </span>
                ))}
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#3a3b49]"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
                <span className="lg:py-4 lg:px-3 py-4 px-3  rounded-lg text-center bg-[#3a3b49]"></span>
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton
                ...
                otherClasses="!bg-[rgba(185,145,85,1)]"
              />
            </div>
          )}
        </div>
